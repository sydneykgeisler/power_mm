...
#' @param Effect Fixed effects of interest for the power calculation. Can be a
#' single value or a vector containing fixed effects specified in the 'Formula'
#' statement.
#' @param Family Specifies the distribution of the data. The default is "Gaussian".
...
#' not have a residual variance, leave the default as NULL.
#' @param tol The tolerance or standard deviation to be used for the covariance
#' priors. The default is 1e-6.
#'
#' @export

power_mm <- function(Formula, Varcomp, Data, Effect, Family = "Gaussian", Alpha = 0.05,
